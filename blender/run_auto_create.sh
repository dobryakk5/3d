...
# Автоматический запуск скрипта создания 3D стен в Blender
# Для macOS

echo "=========================================="
echo "АВТОМАТИЧЕСКИЙ ЗАПУСК СОЗДАНИЯ 3D СТЕН"
echo "=========================================="
...
SCRIPT_PATH="$SCRIPT_DIR/auto_create_walls.py"
...
echo "Запуск Blender с автоматическим созданием стен..."
echo "Путь к Blender: $BLENDER_PATH"
echo "Путь к скрипту: $SCRIPT_PATH"
echo ""

# Запускаем Blender в фонововом режиме с выполнением скрипта
